                ...
                for i in range(0, ids.size):
			        ...
			        # order)
                     ...
                     if depth :
                         ...
                         bruit_aruco = file_constante(bruit_aruco, tvec[0,0,2], 20)
                         
                         print('bruit aruco :', np.std(bruit_aruco))
                         
                         bruit_realsense = file_constante(bruit_realsense, depth_image[cY,cX]/1000, 20)
                         
                         print('bruit realsense :', np.std(bruit_realsense))
                         
                         print(f'{tvec[0,0,2]:.3f}'+"m", depth_image[cY,cX]/1000)
                         
                         z = depth_image[cY,cX]/1000
